...
//---------------------------------------Screenshot ---------------------------------------------------------------------------------------------------	
	...
	/*public String takeScreenShot(WebDriver driver, String screenshotName) throws IOException
	{
		...
		Files.copy(src, dst);//This class coming from commons IO tool
		
		return dst.getAbsolutePath();//attach the screen shot to expert reports
	}*/
...
//---------------------------------------Screenshot ---------------------------------------------------------------------------------------------------		
	 ...
	 * @throws IOException
	 */
	/*public String takeScreenShot1(WebDriver driver, String screenshotName) throws IOException {
	    TakesScreenshot ts = (TakesScreenshot) driver;
	    File src = ts.getScreenshotAs(OutputType.FILE);

	    // Create a timestamp with a custom format to avoid invalid characters in the filename
	    SimpleDateFormat dateFormat = new SimpleDateFormat("yyyyMMdd_HHmmss");
	    String timestamp = dateFormat.format(new Date());

	    File dst = new File(".\\Screenshot\\" + screenshotName + "_" + timestamp + ".png");
...
//---------------------------------------Screenshot ---------------------------------------------------------------------------------------------------	
	...
	/*	public String takeScreenShot(WebDriver driver, String screenshotName) throws IOException {
	    ...
	    // Replace invalid characters in the screenshotName with underscores (_)
...
//---------------------------------------Screenshot ---------------------------------------------------------------------------------------------------		
	...
	/*public String takeScreenShot(WebDriver driver, String screenshotName) throws IOException {
	    ...
	    // Create the destination file path for the screenshot
	    File dst = new File(screenshotDir, screenshotName + "_" + timestamp + ".png");

	    // Copy the screenshot to the destination file
	    Files.copy(src.toPath(), dst.toPath());

	    return dst.getAbsolutePath(); // Attach the screenshot path to expert reports or use as needed
	}*/
...
//---------------------------------------Screenshot ---------------------------------------------------------------------------------------------------	
	...
	public String takeScreenShot(WebDriver driver, String screenshotName) throws IOException {
	   ...
	   // Create the destination file path for the screenshot
	    File dst = new File(screenshotDir, screenshotName + "_"+ ".png");
